...
class TFNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.Encoder_RGBT1 = Encoder()
        self.Encoder_RGBT2 = Encoder()
        self.Encoder_Block= Encoder_Block()

        self.Decoder_RGBT=ALL_Decoder()
        self.Decoder_Final=ALL_Decoder()

        self.fusion_conv1 = ConvBnrelu2d_3(6, 3)          #混合rgb和t

        self.SCPM = SCPM(1024)

    def forward(self, input_rgb,input_t):     

        p0,p1,p2,p3=self.Encoder_RGBT1(input_rgb)             #共有第一段编码  
        q0,q1,q2,q3=self.Encoder_RGBT2(input_t)               #共有第二段编码  
        ...
        k3=self.SCPM(k3)                                      #语义增强模块

        fusion0,fusion1,fusion2,fusion3,fusion_loss=self.Decoder_RGBT(k0,k1,k2,k3)   #第一段解码     
