...
class TFNet(nn.Module):
    ...
    def __init__(self):
        ...
        self.Decoder=ALL_Decoder()

        self.fuse = ConvBnrelu2d_3(1024, 1024)

    def forward(self, input_rgb,input_t):
          
        r0,r1,r2,r3=self.Encoder_1(input_rgb)             
        t0,t1,t2,t3=self.Encoder_1(input_t)   
        ...
        fusion0,fusion1,fusion2,fusion3,pre=self.Decoder(m0,m1,m2,m3)   #第一段解码     
