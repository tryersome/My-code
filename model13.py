...
#老模型 双流编码器 改res34 model9--13 设置了全新的语义空间转化模块 带语义引导仅使用+融合两分支特征补充细节 和 ＋融合三分支语义
#—————————————————————杂项函数———————————————————————————————————
...
class Encoder_Block(nn.Module):
    ...
    def forward(self,RGB_tensor,T_tensor,RGBT_tensor,p3):
        ...
        #细节特征融合
        m0=detail_res0r+detail_res0t
        m1=detail_res1r+detail_res1t
        m2=detail_res2r+detail_res2t
        #最终语义融合
...
class TFNet(nn.Module):
    # resnet50   [64,240,320]   [256,120,160]  [512,60,80]   [1024,30,40]   [2048,15,20] 
    # resnet34   [64,240,320]   [64,120,160]   [128,60,80]   [256,30,40]    [512,15,20] 
    def __init__(self):
