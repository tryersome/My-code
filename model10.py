...
from fuse_util import ChannelAttention, Three_fusion ,Two_fusion,SCPM,shallow_fusion,deep_fusion
#model9 ---model10  设置全新的语义空间转化模块 带语义引导 使用shallow deep融合三分支特征
#—————————————————————杂项函数———————————————————————————————————
...
class Encoder_Block(nn.Module):
    def __init__(self):
        ...
        self.shallow_fusion0=shallow_fusion(64)
        self.shallow_fusion1=shallow_fusion(256)
        self.shallow_fusion2=shallow_fusion(512)
    ...
    def forward(self,RGB_tensor,T_tensor,RGBT_tensor,p3):
        ...
        #细节特征融合
        m0=self.shallow_fusion0(detail_res0r,detail_res0t,res0rt)
        m1=self.shallow_fusion1(detail_res1r,detail_res1t,res1rt)
        m2=self.shallow_fusion2(detail_res2r,detail_res2t,res2rt)
        #最终语义融合
