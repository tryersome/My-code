...
class TFNet(nn.Module):
    ...
    def forward(self, input_rgb,input_t):
        ...
        input_rgbt=self.fusion_conv1(input_rgbt)              #混合rgbt               

        p0,p1,p2,p3=self.Encoder_RGBT(input_rgbt)             #共有第一段编码  
                                                              #[64,240,320]   [256,120,160]  [512,60,80]   [1024,30,40]  
